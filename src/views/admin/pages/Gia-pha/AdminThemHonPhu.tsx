...
import "./AdminThemHonPhu.css";

function AdminThemHonPhu() {
  ...
  return (
    <div className="adminThemHonPhu-container">
      <div className="detailInfo-card">
        ...
        <div className="detailInfo-header">
          <h3 className="title h3">Thêm hôn phu</h3>
...
export default AdminThemHonPhu;
